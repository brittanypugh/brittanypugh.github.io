...
function getData(){
	...
	var url = "https://api.nytimes.com/svc/mostpopular/v2/mostshared/Magazine/30.json";
	url += '?' + $.param({
	  'api-key': myKey;
	});
...
function appendData(result){
	var url, author, title, abstract, published_date, rankTotalShares, thumbnail;
	...
	cardHtml =  "<div class="row"><div class="col s12 m7"><div class="card"><div class="card-image"><img src=thumbnail><span class="card-title">" + title + "</span></div><div class="card-content"><p>" + publishedDate + "</p><p>" + abstract + "</p></div><div class="card-action"><a href=url>View Article</a></div></div></div></div>";
